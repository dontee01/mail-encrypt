...
public class Decoder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jBtDecode, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jBtDecode, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
...
//            jTextAreaMsg.setText("");
            jTextAreaMsg.setText(new String(encryptUtil.Decrypt(message)));
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, 
                            "Error while decoding the e-mail: " + e.getMessage(),
                            "Error", JOptionPane.ERROR_MESSAGE);
        }
